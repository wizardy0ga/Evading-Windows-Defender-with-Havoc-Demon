...
#define HASH_SEED                           5770
#define hash_NTDLLDLL_sdbm                  0xDFA4400A
#define NTDLL                               hash_NTDLLDLL_sdbm
#define hash_KERNEL32DLL_sdbm               0x835C9EFC
#define KERNEL32                            hash_KERNEL32DLL_sdbm
#define hash_LOADLIBRARYA_sdbm              0xD3097476
#define LOADLIBRARYA                        hash_LOADLIBRARYA_sdbm
#define hash_NTALLOCATEVIRTUALMEMORY_sdbm   0xA472DD7F
#define hash_NTPROTECTVIRTUALMEMORY_sdbm    0x83E2C7ED
#define hash_NTFLUSHINSTRUCTIONCACHE_sdbm   0xAB45A3A8
#define hash_NTWRITEVIRTUALMEMORY_sdbm      0x838699BD

#define NT_API_FUNCTION_HASH_LIST hash_NTALLOCATEVIRTUALMEMORY_sdbm,hash_NTPROTECTVIRTUALMEMORY_sdbm,hash_NTFLUSHINSTRUCTIONCACHE_sdbm, hash_NTWRITEVIRTUALMEMORY_sdbm

typedef struct _SYSTEM_CALLS_TABLE {
    SYSTEM_CALL NtAllocateVirtualMemory;
    SYSTEM_CALL NtProtectVirtualMemory;
    SYSTEM_CALL NtFlushInstructionCache;
...
NTSTATUS NtWriteVirtualMemory(PSYSTEM_CALLS_TABLE SyscallTable, HANDLE ProcessHandle, LPVOID BaseAddress, LPCVOID Buffer, SIZE_T NumberOfBytesToWrite, PSIZE_T NumberOfBytesWritten);

#define OBFUSCATED_SYSCALL 0xF6D9
#define SYSCALL_XOR_KEY 0xF3D6
